...
\hva \and
\infer[\defrule{a-ind}]{
    \cgg \vdash I_k \rightsquigarrow C, I_k^\upsilon \Rightarrow \indtype{\Sigma}{I_k}
}{
    \upsilon = \fresh{1}
}
\and
\infer[\defrule{a-ind-star}]{
    \cgg \vdash I_k^* \rightsquigarrow C, I_k^\rho \Rightarrow \indtype{\Sigma}{I_k}
}{
    \rho = \freshi{1}
}
\hva \and
\infer[\defrule{a-constr}]{
    \cgg \vdash c_\ell \rightsquigarrow C, c_\ell \Rightarrow \constrtype{\Sigma}{c_\ell}{\overline{\upsilon}}
}{
    \overline{\upsilon} = \fresh{\inds{c_\ell}}
}
\hva \and
